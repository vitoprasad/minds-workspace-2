...
def test_prevent_bare_print() -> None:
    # client.py is a command-line tool whose stdout IS its user interface, so its
    # print() calls are legitimate output, not stray debug prints. The rule still
    # applies to the service/library code (auth, upstream, api, runner).
    rc.check_bare_print(_DIR, snapshot(0), excluded_patterns=("client.py",))
